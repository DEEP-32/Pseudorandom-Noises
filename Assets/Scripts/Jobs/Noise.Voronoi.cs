...
public static partial class Noise {
    ...
    public struct Voronoi1D<L,F> : INoise where L : struct, ILattice 
    ...
    public struct Voronoi2D<L,F> : INoise where L : struct, ILattice
        where F : struct,IVoronoiFunction{
    ...
    public struct Voronoi3D<L,F> : INoise where L : struct, ILattice
        where  F : struct,IVoronoiFunction{
